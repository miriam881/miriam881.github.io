...
<style>
        .image-container {
            ...
            margin: 10px 20px; /* Añade espacio alrededor del contenedor */
...
<body>
    ...
    <script>
        ...
        const activities = [
            { name: "Apertura de Propuestas (Fecha limite)", workDays: 5 },
            ...
            { name: "Presentacion de documentos para suscripcion de contrato (fecha limite) ", workDays: 5 },
